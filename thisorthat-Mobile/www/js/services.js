...
.factory('voteFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
            ...
            return $resource(baseURL + "questions/:id/votes", null, {
                'update': {
                    method: 'PUT'
                }
            });
...
.factory('AuthFactory', ['$resource', '$http', '$localStorage', '$rootScope', 'baseURL', 'User', '$ionicPopup', function($resource, $http, $localStorage, $rootScope, baseURL, User, $ionicPopup){
